...
Agni Datta, a cryptologist and researcher concentrating on theoretical computer science at VIT Bhopal University in India, working under the umbrella of SECURE, the Centre of Excellence in Cyber Security, holds memberships in several prestigious professional associations, including the Association for Computing Machinery (ACM), the Institute of Electrical and Electronics Engineers (IEEE), the American Mathematical Society (AMS), and the Society for Industrial and Applied Mathematics (SIAM); he occupies several leadership roles within the institution, covering both academic and non-academic fields. Agni’s research includes multiple fields of interest, including fully homomorphic encryption, lattice-based cryptography, multiparty computation, interactive proof systems, and algorithmic number theory. Agni’s range of interests extends beyond academics, including an affection for photography, a proclivity for classical literature, and an admiration for classical music.
