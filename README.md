...
Hi! I am Agni Datta, a final-year graduate student pursuing an integrated Master of Technology in Computer Science with a specialization in Cybersecurity at VIT Bhopal University, Bhopal, Madhya Pradesh, India. My academic interests include cybersecurity, digital forensics, and digital resilience, with a particular emphasis on proof systems and provable security. My research primarily concentrates on theoretical computer science and cryptography.
...
My research interests primarily focus on cryptography, with specific emphasis on the following areas:

- Zero-knowledge proofs
- Rational proofs
- Provable security  

It is important to note that this list is not exhaustive. I maintain an open stance towards exploring any topic related to the practical application of computational complexity and cryptographic primitives.
...
For secure communication, you may retrieve my public key from [this location](https://keys.openpgp.org/vks/v1/by-fingerprint/034FA3D4FD4067E5BCF30B6FCF8D56CABE52E5E9). You are authorized to establish a secure communication channel using this public key. Alternatively, you may execute the following command in a terminal:
