...
My name is Agni Datta. I am a final-year graduate student pursuing an integrated M.Tech in Computer Science with a minor in Cybersecurity at VIT Bhopal University, Bhopal, Madhya Pradesh, India. I have a strong background in cybersecurity, specifically in applied cryptography, advanced digital forensics, and data extraction.

My research interests primarily revolve around cryptography’s foundational and theoretical aspects, focusing on zero-knowledge proofs, multiparty computation, provable security, and identity-based cryptography. Generally, my focus is on security primitives for provable security, along with exploring computational complexity and probabilistic proofs for use in cryptography-proof systems.
